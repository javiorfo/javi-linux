...
- `Languages & Prog utils:` lua, lua-language-server, jdk21-openjdk, go, gopls, delve, rust, rust-analyzer, cmake, clang, netcat, tree, lsof, maven, neovim, jq, tidy, docker, docker-compose, docker-buildx, minikube, kubectl, ripgrep, jwt-cli, plantuml
