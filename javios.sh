...
# PROGRAMMING
lua, lua-language-server, jdk21-openjdk, rust, rust-analyzer, go, gopls, clang, netcat, tree, lsof, maven, gradle, neovim, jq, tidy, docker, docker-compose, docker-buildx, minikube, kubectl, ripgrep, jwt-cli, plantuml
